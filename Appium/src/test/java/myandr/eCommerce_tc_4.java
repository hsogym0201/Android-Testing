...
public class eCommerce_tc_4 extends BaseTest{
	...
	{
        // ************ neglect (pre-condition Scenarios 1, 4)  start ************
...
//		driver.findElements(By.xpath("//android.widget.TextView[@text='ADD TO CART']")).get(0).click();
    	...
    	Thread.sleep(7000);
    	// ************ neglect (pre-condition Scenarios 1, 4)  end ************
    	

    	// Test Scenarios 5 : Verify If user can navigate to WebView, do operations on WebView,go back to Native App
    	Set<String> contexts =driver.getContextHandles();
    	for(String contextName :contexts){
    		System.out.println(contextName); // print all contexts to get the name
    	}
    	driver.context("WEBVIEW_com.androidsample.generalstore");//chrome driver
    	driver.findElement(By.name("q")).sendKeys("JAYH");
